...
type InventoryClient interface {
	...
	AddNewBook(ctx context.Context, in *Book, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *inventoryClient) AddNewBook(ctx context.Context, in *Book, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/Inventory/AddNewBook", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InventoryServer interface {
	...
	AddNewBook(context.Context, *Book) (*Response, error)
...
func (UnimplementedInventoryServer) AddNewBook(context.Context, *Book) (*Response, error) {
...
func _Inventory_AddNewBook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Book)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InventoryServer).AddNewBook(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Inventory/AddNewBook",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InventoryServer).AddNewBook(ctx, req.(*Book))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Inventory_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Inventory_AddNewBook_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "bookshop/bookshop.proto",
}
